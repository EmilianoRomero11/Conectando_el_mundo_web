...
#{"model": "dall-e-3", "prompt": "2023 Subaru BRZ", "size": "1024x1024", "quality": "standard", "n": 1}
secret_key = ""

app = func.FunctionApp(http_auth_level=func.AuthLevel.ANONYMOUS)

@app.route(route="secondapifunction")
def secondapifunction(req: func.HttpRequest) -> func.HttpResponse:
